...
<section class="text-with-offset-images position-relative pt-5 pt-lg-10 pb-lg-2 <?php echo $padding_top; ?> <?php echo $padding_bottom; ?> <?php echo $custom_classes; ?>" style="<?php echo $custom_css; ?>" id="<?php echo $custom_id; ?>">
    <div class="container">
