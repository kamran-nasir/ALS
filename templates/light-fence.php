					...
					<div class="col-12">
						<ul class="nav nav-tabs flex-lg-wrap justify-content-center flex-nowrap horizentol-scroll-mobile">
							<?php //$i=0; foreach ( $termchildren as $child ) { $term = get_term_by( 'id', $child, $taxonomy_name );?>
								<li class="active<?php //if($i==0) echo 'active';?>"><a class="btn-corner-radius" data-toggle="tab" href="#tab-1<?php //echo $i;?>">6x6<?php //echo $term->name;?></a></li>
							<?php //$i++;}?>									
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="tab-content">
					<?php //$i=0; foreach ( $termchildren as $child ) { $term = get_term_by( 'id', $child, $taxonomy_name );?>
						<div id="tab-1<?php //echo $i;?>" class="tab-pane active<?php //if($i==0) echo 'active';?>">
						<?php the_content();?>
