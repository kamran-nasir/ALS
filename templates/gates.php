		...
		<div class="row justify-content-center">
		  <div class="col-md-9 col-xl-6">
				<div class="hero-content position-relative z-index-1 text-center text-white">
				  <h2 class="heading-animation text-white">Gates</h2>
					<p class="text-animation">Keep your kids and pets safe with a secure gate.</p>
				</div> <!-- .hero-content -->
			</div> <!-- .col-md-6 -->
		</div> <!-- .row -->
	</div> <!-- .container -->
			...
			<div class="col-md-9">
				<div class="title-row">
					<div class="title-wrap">
						<h4 class="text-animation m-0">Aluminum Light Solutions gates are the perfect way to enhance your home or business property with style and security. Our gates are designed to protect your property while providing a beautiful gateway for guests.</h4>
					</div> <!-- .title-wrap -->
				</div> <!-- .title-row -->
			</div> <!-- .col-12 -->
		</div> <!-- .row -->
		...
		<div class="row g-0 justify-content-center align-items-center text-center">
			<div class="col-lg-12 order-2 order-lg-1">
				...
				<div class="title-wrap mt-4">
					<h3 class="heading-animation m-0 fw-bold">w804 x 1520mm</h3>
				</div> <!-- .title-wrap -->
	    </div> <!-- .col-md-6 -->
		</div> <!-- .row -->
	</div> <!-- .container -->
